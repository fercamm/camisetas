...
// print_r('feeeer');die;
	...
	include_once('includes/inc.pedido.php');
	include_once('includes/inc.funciones.php');

	//include_once('includes/mercadopago_estado.php');

	$common_dir = substr( $_SERVER['REQUEST_URI'] , 0, 22 ) === "/personalizador/pedido";
	$minCamisetas = 7;
	traerPrecios();
	traerParametros();
...
<html>
	<head>
		...
		<link rel="stylesheet" href="/personalizador/common/css/style.css" />
		<link rel="stylesheet" href="/personalizador/common/css/pedido.css" />
		<link rel="stylesheet" href="/personalizador/common/css/pedido_mb.css" />
		<link rel="stylesheet" href="/personalizador/common/css/mobile.css" />
		<link rel="stylesheet" href="/personalizador/common/css/style_edit_pedido.css" />
	...
	<body>
		<div>
			<div class="desktop">
				<header>
					<div class="left">
						<img src="/personalizador/common/img/logo_yakka.png" alt="Yakka" />
					</div>
					<div class="right">
						<ul class="top">
							<li>
			...
			<div class="mobile header_pedido_mb">
				<img src="/personalizador/common/img/yakka_mobile.png" alt="Yakka" />
			</div>
					...
					<div class="content_finalizado">
						<div class="top">
							...
							<div class="sidebarBox">
								<div class="scrollingBox" style="z-index: 99; background: rgb(255, 255, 255); margin-left: -50px; width: 342px; margin-bottom: 40px; padding-bottom: 0px;">
									...
									<table id="costoTotal" style="margin-top:15px;">
										<tbody><tr><td style="padding-left:8px; border-bottom:1px solid #ccc;">Precio por <?php echo $genero == 'chombas' ? 'chomba' : 'camiseta' ?>:</td><td style="padding-left:8px; border-bottom:1px solid #ccc; font-weight:bold;" align="right">$ <?=$precioCamisetas?></td></tr>
										<tr><td style="padding-left:8px; border-bottom:1px solid #ccc;">Cantidad de <?php echo $genero == 'chombas' ? 'chombas' : 'camisetas' ?>: </td><td style="padding-left:8px; border-bottom:1px solid #ccc; font-weight:bold;" align="right"><?=$cantCamisetas?></td></tr>
										<?php if($pedido->option_short_arquero_on || $pedido->option_short_on){ ?>
											<tr><td style="padding-left:8px; border-bottom:1px solid #ccc;">Precio por short: </td><td style="padding-left:8px; border-bottom:1px solid #ccc; font-weight:bold;" align="right">$ <?=$precioShorts?></span></td></tr>
											<tr><td style="padding-left:8px; border-bottom:1px solid #ccc;">Cantidad de shorts: </td><td style="padding-left:8px; border-bottom:1px solid #ccc; font-weight:bold;" align="right"><?=$cantShorts?></td></tr>
										<?php } ?>
										<?php if($pedido->option_medias_on){ ?>
											<tr><td style="padding-left:8px; border-bottom:1px solid #ccc;">Precio por medias: </td><td style="padding-left:8px; border-bottom:1px solid #ccc; font-weight:bold;" align="right">$ <?=$precioMedias?></td></tr>
											<tr><td style="padding-left:8px; border-bottom:1px solid #ccc;">Cantidad de medias: </td><td style="padding-left:8px; border-bottom:1px solid #ccc; font-weight:bold;" align="right"><?=$cantMedias?></td></tr>
										<?php } ?>
										</tbody>
										<tfoot>
											<tr><td style="background:#d8b13c; color:#FFF; padding-left:16px; padding-bottom: 5px;"><b>Precio Total:</b><br></td><td style="background:#d8b13c; color:#FFF;"><b>$ <span class="precioTotal"><?=$total?></span></b></td></tr>
											<?php
												if(in_array($estado_actual, array(1, 2))){
											?>
												<tr><td style="background:white; padding-left:8px; border-bottom:1px solid #ccc;">Pagado: </td><td style="background:white; padding-left:8px; border-bottom:1px solid #ccc; font-weight:bold;" align="right">$ <?=$pagado?></td></tr>
												<tr class="costoConDescuento" style="display: none;"><td style="background:yellow; padding-left:8px; border-bottom:1px solid #ccc;">Descuento aplicado:</td><td style="background:yellow; padding-left:8px; border-bottom:1px solid #ccc;"><span class="descuentoAplic"></span></td></tr>
												<tr class="costoConDescuento" style="display: none;"><td style="background:yellow; padding-left:8px; border-bottom:1px solid #ccc;"><b>Precio c/Descuento:</b></td><td style="background:yellow; padding-left:8px; border-bottom:1px solid #ccc;"><b>$ <span class="precioTotalD"></span></b></td></tr>
												<tr><td style="background:white; padding-left:8px; border-bottom:1px solid #ccc;"><b>Restante a pagar: </b></td><td style="background:white; padding-left:8px; border-bottom:1px solid #ccc; font-weight:bold;" align="right">$ <span id="restante"><?=$total - $pagado?></span></td></tr>
												<tr><td style="background:white; padding-left:8px; border-bottom:1px solid #ccc; padding-bottom: 5px;" colspan="2"><center><div style="display: none;" id="loading_btn_enviar"><i class="fa fa-spinner fa-spin"></i> procesando...</div><input type="button" class="btn btn-primary" value="PAGAR" onclick="solicitarMercadoPago();" style="height: 50px; width: 250px; <?php ($total - $pagado) > 0 ? 'display: none;' : '' ?>" id="btn_mp"></center></td></tr>
											<?php 
												}
											?>
										</tfoot>
									...
									<table style="margin-top:5px; width: 100%;">
										<tbody>
											<tr>
												...
												<td style="padding-left: 20px; padding-left:8px; border-bottom:1px solid #ccc; font-weight: bold;" align="right"><?=$param_tiempo_entrega->valor + $param_demora->valor?> días</td>
											</tr>
										</tbody>
									</table>
								</div>
							...
							<div class="vista_modelos">
								<div class="vista_modelo_jugador vista_modelo_contenedor">
									<div class="top_title" style="height: 30px;">
										<img src="/personalizador/common/img/jugador_form_ico.png" />
									...
									<div class="final_preview_front" style="z-index:0;">
										...
										?>	
												<img src="<?= $common_dir ? ($pedido->tipo == 'h' ? '../personalizador/hombre/' : ($pedido->tipo == 'm' ? '../personalizador/mujer/' : '../personalizador/mujer/')) : '' ?>img/modelos/modelo_<?= $pedido->diseno ?>/color_secundario/frente/<?= $pedido->color_secundario ?>.png" class="img_secundaria" style="z-index:2;" alt=""/>
										<?php
											}
										}
										?>
										<img src="<?= $common_dir ? ($pedido->tipo == 'h' ? '../personalizador/hombre/' : ($pedido->tipo == 'm' ? '../personalizador/mujer/' : '../personalizador/mujer/')) : '' ?>img/modelos/modelo_<?= $pedido->diseno ?>/color_principal/frente/<?= $pedido->color_principal ?>.png" class="img_principal" style="z-index:1;" />
										<img src="<?= $common_dir ? ($pedido->tipo == 'h' ? '../personalizador/hombre/' : ($pedido->tipo == 'm' ? '../personalizador/mujer/' : '../personalizador/mujer/')) : '' ?>img/modelos/modelo_base/frente/<?= $pedido->color_base ?>.png" class="img_base"  style="z-index:0;"/>
									</div>					
									<div class="final_preview_back" style="z-index:0;">
										...
										if (in_array($pedido->diseno, $with_secundario)) {
											if( $pedido->color_secundario > 0 ){
										?>	
												<img src="<?= $common_dir ? ($pedido->tipo == 'h' ? '../personalizador/hombre/' : ($pedido->tipo == 'm' ? '../personalizador/mujer/' : '../personalizador/mujer/')) : '' ?>img/modelos/modelo_<?= $pedido->diseno ?>/color_secundario/espalda/<?= $pedido->color_secundario ?>.png" class="img_secundaria"  style="z-index:2;" alt=""/>
										<?php
											}
										}
										?>
										<img src="<?= $common_dir ? ($pedido->tipo == 'h' ? '../personalizador/hombre/' : ($pedido->tipo == 'm' ? '../personalizador/mujer/' : '../personalizador/mujer/')) : '' ?>img/modelos/modelo_<?= $pedido->diseno ?>/color_principal/espalda/<?= $pedido->color_principal ?>.png" class="img_principal"  style="z-index:1;"/>
										<img src="<?= $common_dir ? ($pedido->tipo == 'h' ? '../personalizador/hombre/' : ($pedido->tipo == 'm' ? '../personalizador/mujer/' : '../personalizador/mujer/')) : '' ?>img/modelos/modelo_base/espalda/<?= $pedido->color_base ?>.png" class="img_base"  style="z-index:0;"/>
										<div class="formato_nro_back">
											<img src="<?= $common_dir ? ($pedido->tipo == 'h' ? '../personalizador/hombre/' : ($pedido->tipo == 'm' ? '../personalizador/mujer/' : '../personalizador/mujer/')) : '' ?>img/numeros/<?= $pedido->formato ?>/<?= $pedido->color_nro ?>.png" alt="">
										</div>
									</div>
									<div class="footer" style="margin-top: 30px; z-index:0;">
										<p>CAMISETA PERSONALIZADA EN</p>
										<img src="/personalizador/common/img/yakka_min.png" alt="Yakka" />
									</div>
								</div>
								<?php
								...
								<div class="vista_modelo_arquero vista_modelo_contenedor">
									<div class="top_title" style="height: 30px;">
										<img src="/personalizador/common/img/arquero_form_ico.png" />
									...
									<div class="final_preview_front" style="z-index:0;">
										...
										?>	
												<img src="<?= $common_dir ? ($pedido->tipo == 'h' ? '../personalizador/hombre/' : ($pedido->tipo == 'm' ? '../personalizador/mujer/' : '../personalizador/mujer/')) : '' ?>img/modelos/modelo_<?= $pedido->diseno_arquero ?>/color_secundario/frente/<?= $pedido->color_secundario_arquero ?>.png" class="img_secundaria" alt=""/>
										<?php
											}
										}
										?>
										<img src="<?= $common_dir ? ($pedido->tipo == 'h' ? '../personalizador/hombre/' : ($pedido->tipo == 'm' ? '../personalizador/mujer/' : '../personalizador/mujer/')) : '' ?>img/modelos/modelo_<?= $pedido->diseno_arquero ?>/color_principal/frente/<?= $pedido->color_principal_arquero ?>.png" class="img_principal" />
										<img src="<?= $common_dir ? ($pedido->tipo == 'h' ? '../personalizador/hombre/' : ($pedido->tipo == 'm' ? '../personalizador/mujer/' : '../personalizador/mujer/')) : '' ?>img/modelos/modelo_base/frente/<?= $pedido->color_base_arquero ?>.png" class="img_base" />
									</div>					
									<div class="final_preview_back" style="z-index:0;">
										<?php
										if (in_array($pedido->diseno_arquero, $with_secundario)) {
											if( $pedido->color_secundario_arquero > 0 ){
										?>	
												<img src="<?= $common_dir ? ($pedido->tipo == 'h' ? '../personalizador/hombre/' : ($pedido->tipo == 'm' ? '../personalizador/mujer/' : '../personalizador/mujer/')) : '' ?>img/modelos/modelo_<?= $pedido->diseno_arquero ?>/color_secundario/espalda/<?= $pedido->color_secundario_arquero ?>.png" class="img_secundaria" style="z-index:2;" alt=""/>
										<?php
											}
										}
										?>
										<img src="<?= $common_dir ? ($pedido->tipo == 'h' ? '../personalizador/hombre/' : ($pedido->tipo == 'm' ? '../personalizador/mujer/' : '../personalizador/mujer/')) : '' ?>img/modelos/modelo_<?= $pedido->diseno_arquero ?>/color_principal/espalda/<?= $pedido->color_principal_arquero ?>.png" class="img_principal"  style="z-index:1;"/>
										<img src="<?= $common_dir ? ($pedido->tipo == 'h' ? '../personalizador/hombre/' : ($pedido->tipo == 'm' ? '../personalizador/mujer/' : '../personalizador/mujer/')) : '' ?>img/modelos/modelo_base/espalda/<?= $pedido->color_base_arquero ?>.png" class="img_base"  style="z-index:0;"/>
										<div class="formato_nro_back">
											<img src="<?= $common_dir ? ($pedido->tipo == 'h' ? '../personalizador/hombre/' : ($pedido->tipo == 'm' ? '../personalizador/mujer/' : '../personalizador/mujer/')) : '' ?>img/numeros_arq/<?= $pedido->formato_arquero ?>/<?= $pedido->color_nro_arquero ?>.png">
										</div>
									</div>
									<div class="footer" style="margin-top: 30px; z-index:0;">
										<p>CAMISETA PERSONALIZADA EN</p>
							...
							<div class="vista_modelos">
								...
								<div class="vista_modelo_short vista_modelo_contenedor">
									<div class="top_title" style="height: 30px;">
										<img src="/personalizador/common/img/shorts_form_ico.png" />
										<span>SHORTS</span>
									</div>
									<div class="final_preview_short_content">
										<div class="final_preview_short" style="z-index:0;">
											...
											?>	
													<img src="/personalizador/common/img/shorts/short_<?= $pedido->diseno_short ?>/color_secundario/<?= $pedido->color_secundario_short ?>.png" class="img_secundaria"  style="z-index:2;" alt=""/>
											<?php
												}
											?>
											<img src="<?= $common_dir ? ($pedido->tipo == 'h' ? '../personalizador/hombre/' : ($pedido->tipo == 'm' ? '../personalizador/mujer/' : '../personalizador/mujer/')) : '' ?>img/shorts/short_<?= $pedido->diseno_short ?>/color_principal/<?= $pedido->color_principal_short ?>.png" class="img_principal"  style="z-index:1;"/>
											<img src="<?= $common_dir ? ($pedido->tipo == 'h' ? '../personalizador/hombre/' : ($pedido->tipo == 'm' ? '../personalizador/mujer/' : '../personalizador/mujer/')) : '' ?>img/shorts/base/<?= $pedido->color_base_short ?>.png" class="img_base"  style="z-index:0;"/>
										</div>
									</div>
									<div class="footer" style="margin-top: 30px; z-index:0;">
										<p>CAMISETA PERSONALIZADA EN</p>
								...
								<div class="vista_modelo_short vista_modelo_contenedor">
									...
									<div class="final_preview_short_content">
										<div class="final_preview_short" style="z-index:0;">
											...
											?>	
													<img src="../personalizador/common/img/shorts/short_<?= $pedido->diseno_short_arquero ?>/color_secundario/<?= $pedido->color_secundario_short_arquero ?>.png" class="img_secundaria"  style="z-index:2;" alt=""/>
											<?php
												}
											?>
											<img src="<?= $common_dir ? ($pedido->tipo == 'h' ? '../personalizador/hombre/' : ($pedido->tipo == 'm' ? '../personalizador/mujer/' : '../personalizador/mujer/')) : '' ?>img/shorts/short_<?= $pedido->diseno_short_arquero ?>/color_principal/<?= $pedido->color_principal_short_arquero ?>.png" class="img_principal"  style="z-index:1;"/>
											<img src="<?= $common_dir ? ($pedido->tipo == 'h' ? '../personalizador/hombre/' : ($pedido->tipo == 'm' ? '../personalizador/mujer/' : '../personalizador/mujer/')) : '' ?>img/shorts/base/<?= $pedido->color_base_short_arquero ?>.png" class="img_base"  style="z-index:0;"/>
										</div>
									</div>
									<div class="footer" style="margin-top: 30px; z-index:0;">
										<p>CAMISETA PERSONALIZADA EN</p>
								...
								?>
									<div class="vista_modelo_medias vista_modelo_contenedor">
										<div class="top_title" style="height: 30px;">
											<img src="/personalizador/common/img/medias_form_ico.png" />
											<span>MEDIAS</span>
										</div>
										<div class="final_preview_medias_content">
											<div class="final_preview_medias" style="z-index:0;">
												...
												<?php } ?>
												<img src="<?= $common_dir ? ($pedido->tipo == 'h' ? '../personalizador/hombre/' : ($pedido->tipo == 'm' ? '../personalizador/mujer/' : '../personalizador/mujer/')) : '' ?>img/medias/frente/<?= $pedido->color_medias ?>.png" class="img_medias" />
												<img src="<?= $common_dir ? ($pedido->tipo == 'h' ? '../personalizador/hombre/' : ($pedido->tipo == 'm' ? '../personalizador/mujer/' : '../personalizador/mujer/')) : '' ?>img/medias/perfil/<?= $pedido->color_medias ?>.png" class="img_medias" />
											</div>
										</div>
										<div class="footer" style="margin-top: 30px; z-index:0;">
											<p>CAMISETA PERSONALIZADA EN</p>
								...
								<input type="hidden" id="precio_short_medias"       value="<?=$precios->cam_short + $precios->cam_media - 2 * $precios->cam ?>" />
							...
							<div class="col-xs-12 col-sm-6">
								...
								?>
										...
										<tbody>
											...
											<?php if($permiteEditar){ ?>
												<tr height="22">
													...
													<?php if( $pedido->option_short_arquero_on == 1 || $pedido->option_short_arquero_on == "1" ): ?>
														<td class="data_jugador talle_short_arquero">
											...
											<?php }else{ ?>
												<tr height="22">
													<td class="data_jugador"><?= $arquero->nombre ?></td>
													<td class="data_jugador"><?= $arquero->nro ?></td>
													<td class="data_jugador"><?= $arquero->talle ?></td>
													<?php if( $pedido->option_short_on == 1 || $pedido->option_short_on == "1" ): ?>
														<td class="data_jugador"><?= $arquero->talle_short ?></td>
													<?php endif; ?>
													<td class="data_jugador"></td>
												</tr>
											<?php } ?>
											<?php
											}
									...
									<?php if($permiteEditar && false){ ?>
										<div id="add_arquero">
											<div class="add_cont">
												<img src="/personalizador/common/img/ico_plus.png" alt="btn_add" class="btn_add"/>
								...
								<table id="list_players">
									...
									<tbody>
											...
											<tr height="22">
												<td class="data_jugador">
													<div class="row" <?= $jugador->nro == '' ? 'style="display: none;"' : '' ?>>
														<input type="text" name="nombre_jugador[]" class="nombre_jugador form-control" style="width: 80%; <?= $jugador->nro == '' ? 'display: none;' : '' ?>" value="<?= $jugador->nombre ?>"/>
													</div>
												</td>
												<td class="data_jugador">
										...
										<?php } else { ?>
											<tr height="22">
												<td class="data_jugador"><?= $jugador->nombre ?></td>
												<td class="data_jugador"><?= $jugador->nro ?></td>
												<td class="data_jugador"><?= $jugador->talle ?></td>
												<?php if( $pedido->option_short_on == 1 || $pedido->option_short_on == "1" ): ?>
													<td class="data_jugador"><?= $jugador->talle_short ?></td>
												<?php endif; ?>
												<td class="data_jugador"></td>
											</tr>
										<?php } ?>
									...
									<div class="col-xs-12">
										<div class="row">
											...
											<div class="col-xs-8">
												...
												<input type='button' id="save_escudo" style="display: none;" class="btn btn-primary" value='GUARDAR' onclick="javascript: guardarImagen('escudo');">
									...
									<div class="col-xs-12">
										<div class="row">
											...
											<div class="col-xs-8">
												...
												<input type='button' id="save_extra" style="display: none;" class="btn btn-primary" value='GUARDAR' onclick="javascript: guardarImagen('extra');">
						...
						<?php if($permiteEditar){ ?>
							<div class="row">
								...
								<input type="email" name="email_owner" id="email_owner" value="" style="width: 200px; display: inline !important;" class="form-control">
								<input type="button" id="btn_enviar_edit" value="Guardar" class="btn btn-primary" style="width: 100px; color: white; border: 0;"/>
		...
		<script src="/personalizador/common/js/jquery-2.2.4.min.js"></script>
		<!-- <script src="https://cdnjs.cloudflare.com/ajax/libs/jspdf/1.3.2/jspdf.min.js"></script> -->
		<script src="/personalizador/common/js/sweetalert2.min.js"></script>
		<script type="text/javascript" src="/personalizador/common/js/bootstrap-toolkit.js"></script>
		<script src="/personalizador/common/js/html2canvas.min.js"></script>
		<script src="/personalizador/common/js/pedido.js" id="pedido_js" cantMinCamisetas="<?php echo $minCamisetas ?>" genero="<?php echo $genero ?>"  
		  relative_path="../personalizador" medias_on="<?php echo $pedido->option_medias_on ?>" short_on="<?php echo $pedido->option_short_on ?>"></script>
		<link href="/personalizador/common/css/bootstrap.css" rel="stylesheet">
		<script src="/personalizador/common/js/bootstrap.js"></script>
